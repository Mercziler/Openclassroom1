<?php 
	...
	class Edit extends CI_Controller
	{
		...
		public function editAdmin() {
			...
			$this->form_validation->set_rules('fname', 'First Name', 'trim|min_length[3]|max_length[30]');
			$this->form_validation->set_rules('lname', 'Last Name', 'trim|min_length[3]|max_length[30]');
