...
class Absence_model extends CI_Model
{
	...
	public function insert_absence($absData) {
		...
		if ($this->db->insert('Absence', $absData))
			header('http://localhost:81/Openclassroom/index.php/login/enseignant');
		else
			echo "string";;
	...
	public function check_absence($idSea, $idEtu) {
        ...
        // num_row doit etre 0 pour qu'on puisse dire que l'affectation d'absence n'a pas encore effectuer
