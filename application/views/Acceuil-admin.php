...
<?php include_once('header.php') ?>
      ...
      <div class="container-fluid" style="background-image:url('<?php echo base_url();?>assets/images/crayon.jpg');">
        <center><h2 class="mt-4">Quel type d'utilisateur voulez vous afficher ?</h2></center>
        <hr>
		...
		<?php if($role =='admin'): ?>
			...
			<center>
				...
				<button type="button" class="btn btn-default btn">
		        	<a href="http://localhost:81/Openclassroom/index.php/pdf/admin">
		...
		<?php elseif($role=='ens'): ?>
			...
			<center>
	  			...
	  			<br><br>
				<button type="button" class="btn btn-default btn">
		        	<a href="http://localhost:81/Openclassroom/index.php/pdf/enseignant">
				    <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
				    Export as XLS</a>
				</button>
			</center>	
		...
		<?php elseif($role=='etu'): ?>
			...
			<center>
	  			...
	  			<br><br>
				<button type="button" class="btn btn-default btn">
		        	<a href="http://localhost:81/Openclassroom/index.php/pdf/etudiant">
				    <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
				    Export as XLS</a>
				</button>
			</center>	
		...
		<?php elseif($role=='mdl'): ?>
			...
			<table class="table table-striped">
		    	...
		    	<tbody>
	  			...
	  			<br><br>
				<button type="button" class="btn btn-default btn">
		        	<a href="http://localhost:81/Openclassroom/index.php/pdf/module">
				    <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
				    Export as XLS</a>
				</button>
			</center>	
	  	...
	  	<?php else: ?>
			...
			<center>
	  			...
	  			<br><br>
				<button type="button" class="btn btn-default btn">
		        	<a href="http://localhost:81/Openclassroom/index.php/export/exportAllAdmin">
				    <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
				    Export as XLS</a>
				</button>
			</center>	
